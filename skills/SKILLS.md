...
- **discord-tools**: Use when the user asks about the bot, server configuration, discord commands, bot settings, channel info, guild settings, or how to use the bot. Keywords: bot, discord, config, settings, channels, guild, server, help, command, usage.
...
- **web-search**: Use when the user asks to search the web, find information, look up facts, check current events, search for something, find results, or get real-time data. Keywords: search, find, look up, web, URL, check, internet, search query, google.
