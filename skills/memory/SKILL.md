...
When users ask you to remember something, use the `remember` tool.
When users want to recall what you've stored, use the `recall` tool (with or without a query).
When users ask to forget or delete a memory, use the `forget_memory` tool.
